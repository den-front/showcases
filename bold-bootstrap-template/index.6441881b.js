...
})({"aJ0yP":[function(require,module,exports) {
...
document.addEventListener("DOMContentLoaded", function() {
    window.addEventListener("scroll", function() {
        ...
        if (window.pageYOffset > 0) ud_header.classList.add("sticky");
        else ud_header.classList.remove("sticky");
        ...
        if (document.body.scrollTop > 50 || document.documentElement.scrollTop > 50) backToTop.style.display = "flex";
...
},{}]},["aJ0yP","5wnyu"], "5wnyu", "parcelRequire9829")
