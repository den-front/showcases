        ...
        WOW.prototype.init = function() {
            ...
            if (this.boxes.length) {
                if (this.disabled()) return this.resetStyle();
                    ...
                    if ((_ref = document.readyState) === "interactive" || _ref === "complete") return this.start();
                    else return document.addEventListener("DOMContentLoaded", this.start);
                }
            }
        };
...
//# sourceMappingURL=index.320a9aea.js.map
